...
const registeredNames = new Set();
        ...
        logger.info(`Preparing to register ${totalCommandsWithSubs} commands total`);
        ...
        if (guildId) {
            try {
                ...
                if (process.env.NODE_ENV !== 'production') {
                    logger.info(`Registering ${commandsToRegister.length} commands for development guild ${guild.name} (${guild.id})`);
                }
                ...
                if (registeredCommands.size !== commandsToRegister.length) {
                    ...
                    logger.info(`Verification passed: ${registeredCommands.size} commands successfully registered in guild`);
                }
